...
Line32 still can not load FULL RELRO excutables now.
Line32 can not load statically linked excutable since linux syscalls are different from windows syscalls.
